...
public class Mainparser {
	...
	ArrayList<Dataset> execute(){
		try{
			final double lat=GlobalPass.currentLat;
			final double lon=GlobalPass.currentLon;
			Log.i("MO2","parser Current "+lat+"  "+lon);
			String Link="https://maps.googleapis.com/maps/api/place/nearbysearch/xml?key="+APIKey+"&location="+lat+","+lon+"&radius=1500&sensor=false&keyword="+GlobalPass.search;
