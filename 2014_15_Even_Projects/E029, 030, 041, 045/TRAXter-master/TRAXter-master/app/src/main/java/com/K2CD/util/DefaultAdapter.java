...
public class DefaultAdapter<T extends Instance> extends ArrayAdapter<T>
{
	...
	{
		super(context, com.TRAXterv2.R.layout.file_list_entry, objects);
...
@Override
							  ...
							  ViewGroup parent)
	{
		...
		View rowView = inflater.inflate(com.TRAXterv2.R.layout.file_list_entry, parent, false);

		T currObject = getItem(position);

		TextView textView = (TextView) rowView.findViewById(com.TRAXterv2.R.id.label);
		...
		currObject.accept(new InstanceVisitor<Object>()
		{
			...
			{
				icon.setImageResource(com.TRAXterv2.R.drawable.track24);
				return null;
			}
