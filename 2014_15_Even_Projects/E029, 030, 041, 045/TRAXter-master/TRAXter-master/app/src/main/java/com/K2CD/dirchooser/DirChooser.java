...
public class DirChooser extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(com.TRAXterv2.R.layout.dir_chooser);
	...
	private void init()
	{
		dirList = (ListView) findViewById(com.TRAXterv2.R.id.dirList);
		currDirLabel = (TextView) findViewById(com.TRAXterv2.R.id.currDirLabel);
		upButton = (ImageView) findViewById(com.TRAXterv2.R.id.up);
		chooseDir = (ImageView) findViewById(com.TRAXterv2.R.id.choose_dir);
