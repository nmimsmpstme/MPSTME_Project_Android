package com.TRAXter.persistance.source.sqlite;

import android.database.Cursor;
import com.TRAXter.persistance.framework.filter.*;
import com.TRAXter.persistance.framework.query.Query;
import com.TRAXter.persistance.framework.mapping.Mapping;
import com.TRAXter.persistance.framework.sort.FieldOrder;
import com.TRAXter.persistance.framework.sort.Order;
import com.TRAXter.persistance.framework.sort.OrderSet;
import com.TRAXter.persistance.framework.sort.RandomOrder;
import com.TRAXter.persistance.source.relational.FieldPersistable;
import com.TRAXter.persistance.source.sql.query.*;
import com.TRAXter.persistance.source.sql.query.Operator;
...
public class QuerySqlite<PROJECTION, TARGET, RESULT> extends Query<Select, WhereClause, OrderClause, RESULT, Cursor, TARGET, PROJECTION>
{
	...
	public WhereClause visit(NotFilter<? super PROJECTION> notFilter)
	{
		Filter<? super PROJECTION> inversedFilter = notFilter.getFilter().accept(new FilterVisitorGenerified<PROJECTION, RESULT,Object,Filter<? super PROJECTION>>()
		{
			...
			{
				final com.TRAXter.persistance.framework.filter.Operator inversedOp;
				switch (fieldFilter.getOperator())
				{
					case NEQ:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.EQ;
						break;
					case EQ:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.NEQ;
						break;
					case GE:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.LT;
						break;
					case GT:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.LE;
						break;
					case LE:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.GT;
						break;
					case LIKE:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.NOT_LIKE;
						break;
					case NOT_LIKE:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.LIKE;
						break;
					case LT:
						inversedOp = com.TRAXter.persistance.framework.filter.Operator.GE;
						break;
					default:
