...
public abstract class FilterListAdapter extends ArrayAdapter<Filter<? super Tables.Tracks>>
{
	...
	{
		super(context, com.TRAXterv2.R.layout.filter_list_entry, objects);
	}
							  ...
							  ViewGroup parent)
	{
		...
		View rowView = inflater.inflate(com.TRAXterv2.R.layout.filter_list_entry, parent, false);

		final Filter<? super Tables.Tracks> currFilter = getItem(position);

		final TextView textView = (TextView) rowView.findViewById(com.TRAXterv2.R.id.label);
		final ImageView icon = (ImageView) rowView.findViewById(com.TRAXterv2.R.id.icon);
		final ImageView deleteIcon = (ImageView) rowView.findViewById(com.TRAXterv2.R.id.delete);
		final LinearLayout chooseFilterArea = (LinearLayout) rowView.findViewById(com.TRAXterv2.R.id.chooseFilterArea);
		...
		currFilter.accept(new TurtleFilterVisitor<Tables.Tracks, Void>()
		{
			...
			public Void visit(DirFilter dirFilter)
			{
				...
				icon.setImageResource(com.TRAXterv2.R.drawable.dir24);
				return null;
			}
		});
