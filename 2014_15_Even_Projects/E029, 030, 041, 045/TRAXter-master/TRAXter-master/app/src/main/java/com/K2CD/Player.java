...
import com.TRAXter.common.MatchFilterVisitor;
import com.TRAXter.controller.BroadcastsHandler;
import com.TRAXter.controller.PhoneStateHandler;
import com.TRAXter.dirchooser.DirChooserConstants;
import com.TRAXter.model.Instance;
import com.TRAXter.model.Track;
import com.TRAXter.persistance.framework.db.ObservableDatabase;
...
import com.TRAXter.player.OutputUsingOnClickListener;
import com.TRAXter.playlist.Playlist;
import com.TRAXter.playlist.playorder.PlayOrderRandom;
import com.TRAXter.playlist.playorder.PlayOrderSorted;
import com.TRAXter.playlist.playorder.PlayOrderStrategy;
import com.TRAXter.preferences.AbstractKey;
import com.TRAXter.preferences.Keys;
import com.TRAXter.preferences.Preferences;
import com.TRAXter.preferences.PreferencesObserver;
import com.TRAXter.util.Shorty;
import com.TRAXter.view.AlbumArtView;
import com.TRAXter.view.FileChooser;
...
public class Player extends ListActivity
{
	...
	public static final String DIR_CHOOSER_ACTION = "com.TRAXter.player.DIR_CHOOSER";
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(com.TRAXterv2.R.layout.main);
	...
	private void lookupViewElements(){
		...
		progressBar = (SeekBar) findViewById(com.TRAXterv2.R.id.progressBar);

		list = (ImageView) findViewById(com.TRAXterv2.R.id.listButton);
		logo = (ImageView) findViewById(com.TRAXterv2.R.id.logoButton);
		settings = (ImageView) findViewById(com.TRAXterv2.R.id.settingsButton);

		backButton = (ImageView) findViewById(com.TRAXterv2.R.id.backButton);
		playButton = (ImageView) findViewById(com.TRAXterv2.R.id.playButton);
		nextButton = (ImageView) findViewById(com.TRAXterv2.R.id.nextButton);

		shuffleButton = (ImageView) findViewById(com.TRAXterv2.R.id.shuffleButton);
		shuffleCheckBox = (CheckBox) findViewById(com.TRAXterv2.R.id.shuffleCheckBox);

		rescan = (ImageView) findViewById(com.TRAXterv2.R.id.rescan);
		mediaDir = (TextView) findViewById(com.TRAXterv2.R.id.mediaDir);
		rescanProgressBar = (ProgressBar) findViewById(com.TRAXterv2.R.id.rescanProgressBar);
		rescanProgressBarState = (LinearLayout) findViewById(com.TRAXterv2.R.id.rescanState);
		rescanProgressBarIndicatorAll = (TextView) findViewById(com.TRAXterv2.R.id.rescanProgressBarIndicatorAll);
		rescanProgressBarIndicatorState = (TextView) findViewById(com.TRAXterv2.R.id.rescanProgressBarIndicatorState);
		rescanProgressBarIndicatorTrack = (TextView) findViewById(com.TRAXterv2.R.id.rescanProgressBarIndicatorTrack);
		rescanTogglePause = (ImageView) findViewById(com.TRAXterv2.R.id.togglePause);
		chooseMediaDir = (ImageView) findViewById(com.TRAXterv2.R.id.chooseMediaDir);
	}
	...
	private void SetupButtons()
	{
		shuffleButton.setImageDrawable(
				  tp.playlist.preferences.get(Keys.SHUFFLE) ?
							 getResources().getDrawable(com.TRAXterv2.R.drawable.dice48_active) :
							 getResources().getDrawable(com.TRAXterv2.R.drawable.dice48)
		);
	...
	private void SetupObservers()
	{
		...
		tp.playlist.addObserver(new Playlist.PlaylistTrackChangeObserver()
		{
			public void startUpdatePlaylist()
			{
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						...
						rescan.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.fs_scan_stop48));
			...
			public void startRescan(final int toProcess)
			{
				...
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						...
						rescanTogglePause.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.fs_scan_pause48));
			...
			public void pauseRescan()
			{
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						rescanTogglePause.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.fs_scan_unpause48));
					}
				});
			}
			...
			public void endRescan()
			{
				...
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						...
						rescan.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.fs_scan_start48));
					}
				});
			}
					...
					runOnUiThread(new Runnable()
					{
						public void run()
						{
							shuffleButton.setImageDrawable(getResources().getDrawable(
									  shuffle ? com.TRAXterv2.R.drawable.dice48_active : com.TRAXterv2.R.drawable.dice48));
		...
		tp.player.addObserver(new ObservableOutput.PlayerObserver()
		{
			...
			public void started()
			{
				playButton.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.pause96));
			}

			public void stopped()
			{
				playButton.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.play96));
			}
		...
		tp.db.addObserver(new ObservableDatabase.DbObserver()
		{
			...
			public void cleared()
			{
				Toast.makeText(getApplicationContext(), getString(com.TRAXterv2.R.string.toastRescan), Toast.LENGTH_LONG).show();
	...
	{
		nowPlayingSlide = (RelativeLayout) findViewById(com.TRAXterv2.R.id.now_playing_slide);
		playlistSlide = (RelativeLayout) findViewById(com.TRAXterv2.R.id.playlist_slide);
		settingsSlide = (RelativeLayout) findViewById(com.TRAXterv2.R.id.settings_slide);
	...
	{
		duration = (TextView) findViewById(com.TRAXterv2.R.id.trackDuration);
		currTrackPosition = (TextView) findViewById(com.TRAXterv2.R.id.trackCurrPostion);

		ResetHeaderButtons();
		logo.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.logo128_active));
	...
	private void SwitchToPlaylistSlide()
	{
		...
		list.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.list64_active));
	...
	private void SwitchToSettingsSlide()
	{
		...
		settings.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.settings48_active));
...
// ========================================= //
	...
	{
		list.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.list64));
		logo.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.logo128));
		settings.setImageDrawable(getResources().getDrawable(com.TRAXterv2.R.drawable.settings48));
	}
	...
	/**
	 * Async rescan, returns immediately, use {@link com.TRAXter.playlist.Playlist.PlaylistObserver} to receive changes
	 */
