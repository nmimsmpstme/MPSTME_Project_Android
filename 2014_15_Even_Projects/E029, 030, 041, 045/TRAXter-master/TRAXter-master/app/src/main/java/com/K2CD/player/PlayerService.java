...
public class PlayerService extends Service implements Output
{
   ...
   private MediaPlayer getMp(){
	...
	{
		Notification note = new Notification(com.TRAXterv2.R.drawable.play96, getText(com.TRAXterv2.R.string.app_name), System.currentTimeMillis());
		...
		note.setLatestEventInfo(this, getText(com.TRAXterv2.R.string.app_name),
