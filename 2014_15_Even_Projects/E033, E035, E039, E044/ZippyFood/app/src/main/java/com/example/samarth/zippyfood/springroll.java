...
public class springroll extends ActionBarActivity {
Button button104;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_springroll);
        button104 = (Button) findViewById(R.id.button104);
        button104.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        NotificationCompat.Builder notification = new NotificationCompat.Builder(springroll.this);
        ...
        nm.notify(28,n);
                ...
                testObject.put("Order", "SPRING ROLL");
