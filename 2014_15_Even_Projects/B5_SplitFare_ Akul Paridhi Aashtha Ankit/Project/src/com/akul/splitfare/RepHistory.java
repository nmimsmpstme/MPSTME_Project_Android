...
public class RepHistory extends ActionBarActivity 
{
...
String t;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_rep_history);
	...
	{
		getMenuInflater().inflate(R.menu.rep_history, menu);
		return true;
	}
...
public class Fetch extends AsyncTask<Void,Void,Void>
{
	...
	private Handler handler = new Handler()
	{
	      ...
	      public void handleMessage( Message msg )
	            {
	             Toast.makeText(RepHistory.this,"ERROR: "+msg.getData().getString( "message" ), Toast.LENGTH_LONG ).show();
	...
	protected Void doInBackground(Void... arg0) 
	{
		try
		{
			Document d = Common.getdoc("http://akul.cu.cc/getrephist.php?g="+gid+"&u="+ConfigHandler.getuid().trim());
			...
			for(int x =0 ;x<nl.getLength();x++)
			{
				...
				r.add(new Repayment("Me -> "+name,amt,date));
			}
		}
