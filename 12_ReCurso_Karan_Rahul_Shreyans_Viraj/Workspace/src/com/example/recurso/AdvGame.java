...
public class AdvGame extends Activity implements OnClickListener, OnInitListener, OnDismissListener {
	
	SQLiteDatabase db;
	Cursor c;
	int what_to_disp=0,number,count,rr,gg,bb; 
	...
	public void onBackPressed() {
		...
		new AlertDialog.Builder(AdvGame.this)  
